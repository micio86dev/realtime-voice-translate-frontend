...
export const IconMinusCircle = (props: ItemProps) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" class={ `icon icon-tabler icon-tabler-arrow-down-right ${ className || "w-5 h-5" }` } x="0px" y="0px" width="24" height="24" viewBox="0 0 24 24" fill="none">
